...
%buildRadar  Create and configure a fusionRadarSensor.
    ...
    % RCS Signature — enable sensor to use target platform Signatures
    % When true, fusionRadarSensor reads the rcsSignature attached to each
    % target platform and uses it in the radar equation to compute Pd.
    % Without this, ALL targets get the same fixed DetectionProbability.
    % Ref: https://www.mathworks.com/help/fusion/ref/fusionradarsensor-system-object.html
