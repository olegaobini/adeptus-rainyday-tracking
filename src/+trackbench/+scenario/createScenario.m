...
radar = fusionRadarSensor(1,'Rotator', ...
    ...
    'AzimuthResolution', radarCfg.fov_azimuth, ...
    'ReferenceRange', radarCfg.reference_range, ...
    'ReferenceRCS', radarCfg.reference_rcs, ...
    'RangeResolution', radarCfg.range_resolution, ...
    'HasINS', true, ...
    'MechanicalAzimuthLimits', radarCfg.azimuth_limits, ...
    'DetectionCoordinates', 'Scenario', ...
    'DetectionProbability', radarCfg.detection_probability, ...
    'FalseAlarmRate', radarCfg.false_alarm_rate);
