...
Left-click on the map = add waypoint. "Export JSON" writes to `config/targets/waypoints/<n>.json`.
Then reference it in a run file like any other target: `"targets": "waypoints/<n>"`.
