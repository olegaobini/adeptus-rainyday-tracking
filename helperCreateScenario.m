...
% 
% Model the scanning radar with the above specifications using the |fusionRadarSensor|.
...
radar = fusionRadarSensor(1,'Rotator', ...
    ...
    'HasINS', true, ...
    'MechanicalAzimuthLimits', [250 290], ...
...
%%
% The |fusionRadarSensor| models range and elevation bias due to atmospheric
...
%%
% Add two targets within the surveillance area. At the beginning of the
